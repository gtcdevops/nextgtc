...
{/* hidden fields */}
<div className="grid-cols-4 gap-4 p-8">
      <p className="text-lg"><span className="font-light text-md">Vehicle Type:</span>&nbsp; {inputFieldVehicleType}</p>
      <p className="text-lg"><span className="font-light text-md">Zone Fare:</span>&nbsp; {postalFare}</p>
      <p className="text-lg"><span className="font-light text-md">Vehicle Fare:</span>&nbsp; {vehicleFare}</p>
      <p className="text-lg"><span className="font-light text-md">Type of Transfer:</span>&nbsp; {formData.typeoftransfer}</p>
      <p className="text-lg"><span className="font-light text-md">Pickup:</span>&nbsp; {formData.pickup}</p>
      <p className="text-lg"><span className="font-light text-md">Dropoff:</span>&nbsp; {formData.dropoff}</p>
      <p className="text-lg"><span className="font-light text-md">Postal:</span>&nbsp; {formData.postal}</p>
      <p className="text-lg"><span className="font-light text-md">Pax:</span>&nbsp; {formData.pax}</p>
      <p className="text-lg"><span className="font-light text-md">Luggage:</span>&nbsp; {formData.luggage}</p>
      <p className="text-lg"><span className="font-light text-md">Final Fare :</span>&nbsp; {finalFare}</p>
  </div>
    </div> 
    </form>
